...
public struct PrelimAssesmentResponse: Codable {
    ...
    public init(createdOn: Int64?, updatedOn: Int64?, tenantId: String?, applicationId: String?, archived: Bool?, externalId: String?, active: Bool?, id: String?, assesmentForm: Form?, patientId: String?, carriedBy: String?, assesmentDate: Int64?, assignerName: String?) {
