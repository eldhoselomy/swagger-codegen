...
public struct ReferralResponseDTO: Codable {
    ...
    public var responsibilityResponseDTO: ResponsibilityResponseDTO?
    public var diagnosisCodeResponseDTOS: [DiagnosisCodeResponseDTO]?
    public var prelimAsessmentBluePrintForms: [FormBluePrintResponse]?
    public var evaluationBluePrintForms: [FormBluePrintResponse]?

    public init() {
    }

    public init(firstName: CharSequence?, middleName: CharSequence?, lastName: CharSequence?, gender: Gender?, medicalRecord: CharSequence?, dateOfBirth: CharSequence?, mobile: CharSequence?, ssn: CharSequence?, authNumber: CharSequence?, email: CharSequence?, id: String?, countryCode: String?, address: Address?, referralProvider: ReferralProvider?, icdCodes: [String]?, patientCondition: PatientCondition?, insured: Bool?, insuranceInformation: InsuranceInformation?, referralDocuments: [BlobStorageDocument]?, preAuthDocuments: [BlobStorageDocument]?, prelimForms: [String]?, evaluationForms: [String]?, status: Status?, responsibilityId: String?, timeZone: String?, tenantId: String?, archived: Bool?, active: Bool?, createdOn: Int64?, updatedOn: Int64?, responsibilityResponseDTO: ResponsibilityResponseDTO?, diagnosisCodeResponseDTOS: [DiagnosisCodeResponseDTO]?, prelimAsessmentBluePrintForms: [FormBluePrintResponse]?, evaluationBluePrintForms: [FormBluePrintResponse]?) {
        ...
        self.responsibilityResponseDTO = responsibilityResponseDTO
        self.diagnosisCodeResponseDTOS = diagnosisCodeResponseDTOS
        self.prelimAsessmentBluePrintForms = prelimAsessmentBluePrintForms
        self.evaluationBluePrintForms = evaluationBluePrintForms
    }
