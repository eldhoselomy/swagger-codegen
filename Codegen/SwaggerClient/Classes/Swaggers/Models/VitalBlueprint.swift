...
public struct VitalBlueprint: Codable {
    ...
    public init(createdOn: Int64?, updatedOn: Int64?, tenantId: String?, applicationId: String?, archived: Bool?, externalId: String?, active: Bool?, ownerType: OwnerType?, ownerId: String?, id: String?, name: String?, type: String?, fields: [Field]?, contextFields: [FieldComponent]?, noteEnabled: Bool?, iconURL: String?, contextActuations: [ContextActuationModel]?, primary: Bool?, graphRequired: Bool?) {
