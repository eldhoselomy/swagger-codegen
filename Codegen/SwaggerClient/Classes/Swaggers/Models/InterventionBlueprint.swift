...
public struct InterventionBlueprint: Codable {
    ...
    public init(createdOn: Int64?, updatedOn: Int64?, tenantId: String?, applicationId: String?, archived: Bool?, externalId: String?, active: Bool?, id: String?, name: String?, type: String?, parameters: String?, parentId: String?, careplanBluprintId: String?, schedule: OldScheduleModel?, schedules: [Schedule]?, permissions: String?, caretakerId: String?, caretakerName: String?, caretakerNotificationEnabled: Bool?, patientNotificationEnabled: Bool?, guaridanNotificationEnabled: Bool?, reviewResponseEnabled: Bool?) {
