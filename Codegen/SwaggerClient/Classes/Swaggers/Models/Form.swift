...
public struct Form: Codable {
    ...
    public init(createdOn: Int64?, updatedOn: Int64?, tenantId: String?, applicationId: String?, archived: Bool?, externalId: String?, active: Bool?, ownerType: OwnerType?, ownerId: String?, formHeader: FormHeader?, formFooter: FormFooter?, percentageComplete: Double?, id: String?, name: String?, sectionList: [FormSection]?, type: String?, tags: [String]?, assignerId: String?, assigneeId: String?, assignedOn: Int64?, completedOn: Int64?, completed: Bool?) {
