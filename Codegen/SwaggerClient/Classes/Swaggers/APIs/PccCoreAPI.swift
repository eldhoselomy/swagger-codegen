...
open class PccCoreAPI {
     ...
     */
    open class func getFacilites(tenantId: String? = nil, completion: @escaping ((_ data: [Facility]?,_ error: Error?) -> Void)) {
        getFacilitesWithRequestBuilder(tenantId: tenantId).execute { (response, error) -> Void in
  ...
  "bedCount" : 1
     ...
     */
    open class func getFacilitesWithRequestBuilder(tenantId: String? = nil) -> RequestBuilder<[Facility]> {
        let path = "/ehealth/v2/pcc/core/facs"
  ...
  "maritalStatus" : "maritalStatus"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPatients(facId: String, tenantId: String? = nil, completion: @escaping ((_ data: [Patient]?,_ error: Error?) -> Void)) {
        getPatientsWithRequestBuilder(facId: facId, tenantId: tenantId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
    ...
    /**
     - GET /ehealth/v2/pcc/core/facs/{facId}/patients
     - examples: [{contentType=application/json, example=[ {
  "languageDesc" : "languageDesc",
  "lastName" : "lastName",
  "gender" : "gender",
  ...
  "maritalStatus" : "maritalStatus"
     ...
     - returns: RequestBuilder<[Patient]> 
     */
    open class func getPatientsWithRequestBuilder(facId: String, tenantId: String? = nil) -> RequestBuilder<[Patient]> {
        var path = "/ehealth/v2/pcc/core/facs/{facId}/patients"
        let facIdPreEscape = "\(facId)"
        let facIdPostEscape = facIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{facId}", with: facIdPostEscape, options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "username" : "username"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func sync(tenantId: String? = nil, completion: @escaping ((_ data: Bool?,_ error: Error?) -> Void)) {
        syncWithRequestBuilder(tenantId: tenantId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
     ...
     */
    open class func syncWithRequestBuilder(tenantId: String? = nil) -> RequestBuilder<Bool> {
        let path = "/ehealth/v2/pcc/core/sync"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
